    ...
    <div class="container">
      <div class="row q-col-gutter-y-lg q-col-gutter-x-md justify-between">
        <div class="col-12 col-md-4 flex column">
          <h2 class="ares__text-title">Call for EU Workshops</h2>
          <q-separator />
          <q-space />
...
const callText = computed<MarkdownText | null>(() => contentsDict.value['call_for_eu_workshops']?.value || null);

useMeta(() => {
  return {
    title: 'Call for EU Workshops',
  };
});
</script>
