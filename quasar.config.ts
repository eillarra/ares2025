...
export default configure((/* ctx */) => {
  return {
    ...
    // https://quasar.dev/quasar-cli-vite/quasar-config-js#sourcefiles
    // sourceFiles: {
    ...
    pwa: {
      workboxMode: 'InjectManifest', // available values: 'GenerateSW', 'InjectManifest'
